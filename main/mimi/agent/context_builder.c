...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        ...
        "- mcp_connect: Connect to an MCP server by name. Server must be defined in mcp-servers.md. "
        "MCP server tools (e.g., echo, get_time) become available ONLY after calling this.\n"
