...
(function() {
    ...
    const translations = {
        en: {
            ...
            'features.agent_3': 'Self-learning: auto-crystallization',
            'features.agent_4': 'L0-L4 memory hierarchy',
            'features.agent_5': 'MCP client for remote tools',
            'features.agent_6': 'Cron scheduler',
        ...
        zh: {
            ...
            'features.agent_3': '自我学习：自动结晶',
            'features.agent_4': 'L0-L4 记忆层级',
            'features.agent_5': 'MCP 客户端动态远程工具',
            'features.agent_6': '定时任务调度',
            'arch.title': '系统架构',
            'arch.desc': '组件如何协同工作',
